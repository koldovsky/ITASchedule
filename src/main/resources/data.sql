...
INSERT INTO `itaschedule`.`address` (`is_active`, `address`, `code_name`, `working_hours_end`, `working_hours_start`, `city_id`) VALUES (true, 'address1', '1', '12:00:00', '10:00:00', '1');
INSERT INTO `itaschedule`.`address` (`is_active`, `address`, `code_name`, `working_hours_end`, `working_hours_start`, `city_id`) VALUES (true, 'address2', '1', '22:00:00', '08:00:00', '1');
INSERT INTO `itaschedule`.`address` (`is_active`, `address`, `code_name`, `working_hours_end`, `working_hours_start`, `city_id`) VALUES (true, 'address3', '1', '21:00:00', '11:00:00', '2');
INSERT INTO `itaschedule`.`address` (`is_active`, `address`, `code_name`, `working_hours_end`, `working_hours_start`, `city_id`) VALUES (true, 'address4', '1', '16:00:00', '08:00:00', '1');
...
INSERT INTO `itaschedule`.`room` (`is_active`, `number`, `address_id`) VALUES (true, '1001', '1');
INSERT INTO `itaschedule`.`room` (`is_active`, `number`, `address_id`) VALUES (true, '1002', '1');
INSERT INTO `itaschedule`.`room` (`is_active`, `number`, `address_id`) VALUES (true, '1003', '1');
INSERT INTO `itaschedule`.`room` (`is_active`, `number`, `address_id`) VALUES (true, '1004', '1');
INSERT INTO `itaschedule`.`room` (`is_active`, `number`, `address_id`) VALUES (true, '2001', '2');
